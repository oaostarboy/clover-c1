...
| Version | `4.0.0` |
| Author | 0xbyt4, Clover Cognition |
| License | MIT |
...
```bash
python3 -m pyfiglet "CLOVER" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=CLOVER&font=Slant" | boxes -d stone
```
