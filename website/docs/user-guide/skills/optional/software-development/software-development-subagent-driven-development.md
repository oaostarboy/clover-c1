...
| | |
|---|---|
| Source | Optional — install with `clover skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | Clover Cognition (adapted from obra/superpowers) |
| License | MIT |
