...
| | |
|---|---|
| Source | Optional — install with `clover skills install official/mlops/peft` |
...
- **[Advanced Usage](https://github.com/CloverCognition/clover-c1/blob/main/optional-skills/mlops/peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/CloverCognition/clover-c1/blob/main/optional-skills/mlops/peft/references/troubleshooting.md)** - Common errors, debugging, optimization
