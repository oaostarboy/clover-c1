...
| | |
|---|---|
| Source | Optional — install with `clover skills install official/mlops/qdrant` |
...
- **[Advanced Usage](https://github.com/CloverCognition/clover-c1/blob/main/optional-skills/mlops/qdrant/references/advanced-usage.md)** - Distributed mode, hybrid search, recommendations
- **[Troubleshooting](https://github.com/CloverCognition/clover-c1/blob/main/optional-skills/mlops/qdrant/references/troubleshooting.md)** - Common issues, debugging, performance tuning
