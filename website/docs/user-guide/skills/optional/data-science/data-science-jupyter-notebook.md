...
| | |
|---|---|
| Source | Optional — install with `clover skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing clover tool access (web_search, file ops). Stateless. |
