...
| | |
|---|---|
| Source | Optional — install with `clover skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.clover/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.clover/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Clover installs package this)
