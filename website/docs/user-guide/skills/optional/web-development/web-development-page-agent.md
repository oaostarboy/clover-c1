...
| | |
|---|---|
| Source | Optional — install with `clover skills install official/web-development/page-agent` |
...
- User wants **Clover itself to drive a browser** → use Clover' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
