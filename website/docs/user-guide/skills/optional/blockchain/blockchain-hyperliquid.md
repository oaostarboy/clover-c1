...
| | |
|---|---|
| Source | Optional — install with `clover skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Clover Cognition |
| License | MIT |
...
The script reads `${CLOVER_HOME:-~/.clover}/.env` for two optional defaults:
...
Helper script: `~/.clover/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.clover/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${CLOVER_HOME:-~/.clover}/.env`.
...
```bash
python3 ~/.clover/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.clover/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
