...
| | |
|---|---|
| Source | Optional — install with `clover skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Clover Cognition |
| License | MIT |
...
```
SCRIPT=~/.clover/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.clover/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
