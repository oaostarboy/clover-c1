...
| | |
|---|---|
| Source | Optional — install with `clover skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`clover-c1`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-clover-c1), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Clover Cognition via the native MCP client. This is the preferred
...
Then configure Clover Cognition to connect via HTTP:
