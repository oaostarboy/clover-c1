...
| | |
|---|---|
| Source | Optional — install with `clover skills install official/research/gitnexus-explorer` |
...
| Related skills | [`clover-c1`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-clover-c1), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
