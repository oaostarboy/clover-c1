...
| | |
|---|---|
| Source | Optional — install with `clover skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Clover Cognition (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $CLOVER_OSINT_CACHE/icij/ (default: ~/.cache/clover-osint/icij/).
...
# Set CLOVER_OSINT_UA=your-app/1.0 (your@email) to identify yourself
