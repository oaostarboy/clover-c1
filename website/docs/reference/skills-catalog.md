...
| [`clover-c1`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-clover-c1) | Use, configure, theme, extend, and orchestrate Clover Cognition. | `autonomous-ai-agents/clover-c1` |
...
| [`clover-c1-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-clover-c1-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/clover-c1-skill-authoring` |
| [`inspecting-clover-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-clover-desktop-dom) | Read the live Clover desktop DOM/CSS over CDP. | `software-development/inspecting-clover-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .clover/plans/; no execution. | `software-development/plan` |
