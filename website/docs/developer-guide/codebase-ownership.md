...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `clover_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `clover_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Clover Plugin](plugins/index.md) |
...
| Session storage | `clover_state.py` | [Session Storage](session-storage.md) |
