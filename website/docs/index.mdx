...
slug: /
sidebar_position: 0
title: "Clover Cognition Documentation"
description: "The self-improving AI agent built by Clover Cognition. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Clover Cognition](https://clover-c1.local). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `clover setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Clover Portal](/integrations/nous-portal).
:::

## What is Clover Cognition?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Clover safely  |
| 🧭 **[Use MCP with Clover](/guides/use-mcp-with-clover)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Clover](/guides/use-voice-mode-with-clover)** | Hands-on setup and usage patterns for Clover voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Clover' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Clover                              |
...
- **Built by model trainers** — Created by [Clover Cognition](https://clover-c1.local), the lab behind Clover, Nomos, and Psyche. Works with [Clover Portal](https://portal.clover-c1.local), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Clover Portal](/integrations/nous-portal) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Clover Cognition](https://clover-c1.local) — the lab behind Clover, Nomos, and Psyche models
