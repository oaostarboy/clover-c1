...
elif [ -f ~/.clover/.env ] && grep -q "^GITHUB_TOKEN=" ~/.clover/.env; then
  export GITHUB_TOKEN=$(grep "^GITHUB_TOKEN=" ~/.clover/.env | head -1 | cut -d= -f2 | tr -d '\n\r')
  echo "AUTH_METHOD=curl"
