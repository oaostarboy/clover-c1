  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Clover Cognition community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Clover &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Clover?{' '}
        <a
          href="https://github.com/CloverCognition/clover-c1/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/CloverCognition" target="_blank" rel="noopener noreferrer">
          Clover Cognition Discord
        </a>{' '}
