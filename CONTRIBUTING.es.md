...
Si tu habilidad es especializada, contribuida por la comunidad o de nicho, es mejor para un **Skills Hub** — súbela a un registro de habilidades y compártela con la comunidad. Los usuarios pueden instalarla con `clover skills install`.
...
- Usa [GitHub Issues](https://github.com/oaostarboy/clover-c1/issues)
