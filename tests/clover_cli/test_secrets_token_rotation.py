"""Tests for `clover secrets bitwarden token` / `clover secrets onepassword token`.
...
from clover_cli import onepassword_secrets_cli as op_cli
from clover_cli import secrets_cli as bw_cli
