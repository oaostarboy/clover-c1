"""Tests for clover_cli.stderr_timestamp."""
...
_LAUNCHD_ENV = {"PATH": "/usr/bin", "XPC_SERVICE_NAME": "ai.clover.gateway-butler"}
...
def test_main_injects_flag_into_stale_gateway_child(tmp_path, monkeypatch):
    ...
    stale = [sys.executable, "-c", code, "-m", "clover_cli.main", "gateway", "run", "--replace"]
