"""Regression: ``clover update`` should take a managed checkout off autocrlf=true.
...
``clover update`` has to repair them.
...
from clover_cli.update_cmd import _normalize_managed_eol
