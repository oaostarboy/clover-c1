"""Tests for ``clover approvals suggest`` (clover_cli/approvals_suggest.py).

Approval history in Clover is implied, not ledgered: the session DB
...
from clover_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
