"""Tests for the specifier module + `clover kanban specify` CLI surface.
...
from clover_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `clover kanban …` argparse surface directly."""
