"""Tests for the shared byte formatter (clover_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from clover_cli.backup import _format_size as backup
    from clover_cli.checkpoints import _fmt_bytes as checkpoints
    from clover_cli.doctor import _human_bytes as doctor
