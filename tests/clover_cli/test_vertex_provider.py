...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (clover_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_clover_overlays():
    """clover_cli.providers.get_provider("vertex") backs
