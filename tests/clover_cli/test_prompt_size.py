"""Tests for the ``clover prompt-size`` diagnostic (issue #34667)."""
...
from clover_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(clover_home, memory_text="", user_text=""):
    mem_dir = clover_home / "memories"
...
def _seed_skill(clover_home, name, description):
    skill_dir = clover_home / "skills" / "demo" / name
