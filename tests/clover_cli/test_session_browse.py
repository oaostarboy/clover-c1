"""Tests for the interactive session browser (`clover sessions browse`).
...
from clover_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """clover sessions browse should be parseable."""
