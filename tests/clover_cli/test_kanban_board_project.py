...
A kanban board can be scoped to a first-class Clover project so every task on
...
def fresh_home(tmp_path, monkeypatch):
    ...
    for var in ("CLOVER_KANBAN_DB", "CLOVER_KANBAN_WORKSPACES_ROOT", "CLOVER_KANBAN_HOME", "CLOVER_KANBAN_BOARD"):
