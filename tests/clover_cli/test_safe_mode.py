"""Tests for `clover chat --safe-mode` isolation."""
...
_VARS = ("CLOVER_SAFE_MODE", "CLOVER_IGNORE_USER_CONFIG", "CLOVER_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["CLOVER_SAFE_MODE"] == "1"
        assert os.environ["CLOVER_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["CLOVER_IGNORE_RULES"] == "1"
        return True
