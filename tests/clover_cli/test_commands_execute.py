...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`clover_cli.slash_exec.EXECUTORS`, and
...
from clover_cli.commands import COMMAND_REGISTRY, resolve_command
from clover_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
