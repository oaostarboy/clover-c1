...
The oneshot path builds its AIAgent directly (bypassing CloverCLI), so the
...
from clover_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
