...
class TestGetCopilotModelContext:
    ...
    @patch("clover_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("clover_cli.models._urlopen_model_catalog_request")
    ...
    @patch("clover_cli.models.fetch_github_model_catalog", return_value=[])
