...
``is_clover_clover_non_agentic`` should only match the actual Clover Cognition
...
@pytest.mark.parametrize(
    "model_name",
    [
        "cloverc1/Clover-3-Llama-3.1-70B",
        "cloverc1/Clover-3-Llama-3.1-405B",
        "clover-3",
        "Clover-3",
        "clover-4",
        "clover-4-405b",
        ...
        "openrouter/cloverc1/clover-4-405b",
        "cloverc1/Clover3",
        "clover-3.1",
    ],
)
def test_matches_real_clover_clover_chat_models(model_name: str) -> None:
    assert is_clover_clover_non_agentic(model_name), (
