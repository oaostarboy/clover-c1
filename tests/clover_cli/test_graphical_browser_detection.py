"""Tests for `_can_open_graphical_browser()` in clover_cli.auth.

Guards the fix for the May 2026 report where `clover auth add xai-oauth`
...
from clover_cli.auth import _can_open_graphical_browser
