...
The main() function in clover_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `clover -c model`
...
def _build_parser():
    """Build a minimal replica of the clover top-level parser."""
