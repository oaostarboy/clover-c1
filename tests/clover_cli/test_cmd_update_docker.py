...
def test_cmd_update_in_docker_prints_guidance_and_exits(
    ...
    """``clover update`` inside Docker → friendly message + exit 2, no git calls.
    ...
    assert "docker pull cloverc1/clover-c1:latest" in out
...
def test_format_docker_update_message_contents():
    ...
    assert "docker pull cloverc1/clover-c1:latest" in msg
