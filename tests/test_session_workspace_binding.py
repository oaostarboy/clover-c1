"""Session <-> workspace grouping key (clover_state.workspace_key).

The key is what `clover sessions list --workspace` groups/filters on. It is a
...
from clover_state import workspace_key
