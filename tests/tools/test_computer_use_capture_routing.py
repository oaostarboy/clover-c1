...
* ``clover_constants.get_clover_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_clover_dir so cache writes land under tmp_path."""
    ...
    with patch("clover_constants.get_clover_dir", _fake_get):
        yield cache_dir
