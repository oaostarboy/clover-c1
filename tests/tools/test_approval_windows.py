...
must match regardless of host OS (a Linux-hosted Clover can still drive a
...
class TestWindowsPathVariant:
    ...
    @pytest.mark.parametrize("cmd", [
        ...
        r"copy C:\Users\me\AppData\Local\clover\.env D:\exfil\e.txt",
        "cat C:/Users/me/AppData/Local/clover/.env",
    ])
