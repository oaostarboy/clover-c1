...
FIXTURE_NO_PROVIDER = (
    "agent init failed: No LLM provider configured. Run `clover model` to select "
    "a provider, or run `clover setup` for first-time configuration."
)
FIXTURE_NO_TOKEN = "agent init failed: No access token found for Clover Portal login."
