...
Real config files in a temp CLOVER_HOME, real resolution chains (no mocked
...
def voice_home(tmp_path, monkeypatch):
    """Isolated CLOVER_HOME + reloaded config modules; yields a config writer."""
    ...
    for var in (
        ...
        "DEEPINFRA_API_KEY", "CLOVER_LOCAL_STT_LANGUAGE",
    ):
