...
class TestWriteFileCrossProfileGuard:
    ...
    def test_cross_profile_write_allowed_guard_retired(self, fake_clover):
...
class TestPatchCrossProfileGuard:
    def test_cross_profile_patch_allowed_guard_retired(self, fake_clover):
    ...
    def test_v4a_patch_writes_through_guard_retired(self, fake_clover):
