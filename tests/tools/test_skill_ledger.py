...
def ledger_env(tmp_path, monkeypatch):
    """Isolated CLOVER_HOME + skills dir for skill_manage and the ledger."""
    ...
    monkeypatch.setattr(skill_ledger, "get_clover_home", lambda: home)
    monkeypatch.setattr(skill_usage, "get_clover_home", lambda: home)
...
def test_rollback_refuses_paths_outside_clover_home(ledger_env):
    """A hand-edited ledger entry pointing outside CLOVER_HOME must not
