...
def test_skill_installs_cleanly_under_skills_guard():
    ...
    # clover_config_mod  — print statements in the post-migration summary that
    #                      tell the user to *review* ~/.clover/config.yaml;
    ...
    KNOWN_FALSE_POSITIVES = {"agent_config_mod", "python_os_environ", "clover_config_mod"}
