...
def make_clover_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated CLOVER_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"clover-home-{journal_mode}"
