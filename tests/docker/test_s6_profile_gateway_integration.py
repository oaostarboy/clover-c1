...
The unit tests in tests/clover_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned clover-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/clover")
from clover_cli.service_manager import S6ServiceManager
