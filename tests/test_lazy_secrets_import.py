"""Regression test: clover update must not load cryptography eagerly."""
...
assert 'clover_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running clover update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so clover_cli is importable,
...
import clover_cli.main
from clover_cli.update_cmd import _cmd_update_check
