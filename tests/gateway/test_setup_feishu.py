"""Tests for _setup_feishu() in clover_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("clover_cli.config.save_env_value", side_effect=mock_save), \
         patch("clover_cli.config.get_env_value", side_effect=mock_get), \
         patch("clover_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("clover_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("clover_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("clover_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("clover_cli.cli_output.print_header"), \
         patch("clover_cli.cli_output.print_info"), \
         patch("clover_cli.cli_output.print_success"), \
         patch("clover_cli.cli_output.print_warning"), \
         patch("clover_cli.cli_output.print_error"), \
