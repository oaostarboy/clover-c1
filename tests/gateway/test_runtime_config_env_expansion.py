...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("CLOVER_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("CLOVER_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("CLOVER_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
