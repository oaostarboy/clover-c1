...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.clover/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at clover_state import time, before pytest's CLOVER_HOME monkeypatch
    fires — the autouse fixture's CLOVER_HOME override doesn't help here.)
    """
    import clover_state
