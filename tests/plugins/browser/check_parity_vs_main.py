...
Run from the PR worktree:
    ...
    cd ~/.clover/clover-c1/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.clover/clover-c1``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.clover/clover-c1
PR_DIR = REPO_ROOT  # the worktree we're in
assert (MAIN_DIR / "tools" / "browser_tool.py").exists(), (
    f"MAIN_DIR={MAIN_DIR} doesn't look like a clover-c1 checkout"
)
...
# Isolated CLOVER_HOME for the config write.
