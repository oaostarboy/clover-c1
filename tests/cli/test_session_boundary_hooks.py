...
from clover_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/clover_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("clover_cli.lifecycle.invoke_hook")
@patch("clover_cli.lifecycle.finalize_session")
