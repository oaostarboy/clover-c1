...
Keeps the ACP server tests offline: ``CloverACPAgent._build_model_state``
calls ``clover_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import clover_cli.inventory as inventory
