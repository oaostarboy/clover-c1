...
part of the bundled-plugins set; a stock clover-c1 install does not see
an "Example" tab in its sidebar. The ``_install_example_plugin`` pytest
fixture in ``tests/clover_cli/test_web_server.py`` copies this directory
into ``$CLOVER_HOME/plugins/example-dashboard/`` and forces the dashboard
