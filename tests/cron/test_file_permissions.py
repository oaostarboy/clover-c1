...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("clover_cli.config.get_config_path", return_value=config_path), \
             patch("clover_cli.config.ensure_clover_home"):
    ...
    def test_ensure_clover_home_sets_0700(self):
        home = Path(self.tmpdir) / ".clover"
