...
class TestDriftAlertOnce:
    def test_two_drifted_ticks_alert_exactly_once(self, tmp_path):
        ...
        with cron_jobs.use_cron_store(tmp_path):
            ...
            for _ in range(2):
                ...
                ok, agent_called = _tick(fresh, tmp_path, "clover", deliveries)
        ...
        assert "pin" in blob
        assert "host running clover" in blob
        ...
        assert "clover cron edit drift-once-test" in deliveries[0]
    ...
    def test_healed_drift_clears_bit_and_redrift_realerts(self, tmp_path):
        ...
        with cron_jobs.use_cron_store(tmp_path):
            ...
            fresh = [j for j in cron_jobs.load_jobs() if j["id"] == job["id"]][0]
            _tick(fresh, tmp_path, "clover", deliveries)
