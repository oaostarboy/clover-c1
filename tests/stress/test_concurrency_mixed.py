...
def worker_loop(worker_id: int, clover_home: str, result_file: str) -> None:
...
def reclaimer_loop(clover_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="clover_mixed_stress_")
    print(f"CLOVER_HOME = {home}")
