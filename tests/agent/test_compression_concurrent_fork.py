...
Damien's incident (Discord, 2026-05-28): a long Clover session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``clover_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "clover_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "clover_state"
