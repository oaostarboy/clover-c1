...
thinking phase.  Clover's default cloud-stream stale detector
(``CLOVER_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``CLOVER_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
