...
class TestResolveVisionMainFirst:
    ...
    def _stub_nous_portal(seen: dict):
        ...
        nous_client.base_url = "https://inference.clover-c1.local/v1"
    ...
    def test_copilot_vision_sets_vision_header(self, monkeypatch):
        ...
        with patch(
            ...
            "clover_cli.copilot_auth.copilot_request_headers",
...
class TestResolveVisionCustomProvider:
    ...
    it returns ``(None, None)`` and vision falls through to OpenRouter / Clover,
