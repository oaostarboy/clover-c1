 ...
 *   marks and a tiny "Clover Cognition" mark in the corner — mirrors the
 *   overlay on the Clover agent website.
...
export interface PosterProps {
  ...
  /**
   * Signature mark. In `vibe` this is the small "Clover Cognition" overlay in the
   * bottom-right. In `dispatch` this is the URL / CTA in the footer.
   */
  signature?: React.ReactNode
  /** Override the poster image. Defaults to the Clover "filler-bg0" asset. */
  src?: string
