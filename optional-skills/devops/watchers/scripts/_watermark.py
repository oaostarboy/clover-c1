...
def _state_dir() -> Path:
    ...
    # Default: $CLOVER_HOME/watcher-state/, falling back to ~/.clover/watcher-state/.
    clover_home = os.environ.get("CLOVER_HOME") or str(Path.home() / ".clover")
    return Path(clover_home) / "watcher-state"
