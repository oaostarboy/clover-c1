...
```bash
python ~/.clover/skills/migration/openclaw-migration/scripts/openclaw_to_clover.py
```
...
```bash
python ~/.clover/skills/migration/openclaw-migration/scripts/openclaw_to_clover.py --preset user-data
```

Execute a user-data migration:

```bash
python ~/.clover/skills/migration/openclaw-migration/scripts/openclaw_to_clover.py --execute --preset user-data --skill-conflict skip
```

Execute a full compatible migration:

```bash
python ~/.clover/skills/migration/openclaw-migration/scripts/openclaw_to_clover.py --execute --preset full --migrate-secrets --skill-conflict skip
```

Execute with workspace instructions included:

```bash
python ~/.clover/skills/migration/openclaw-migration/scripts/openclaw_to_clover.py --execute --preset user-data --skill-conflict rename --workspace-target "/absolute/workspace/path"
```
