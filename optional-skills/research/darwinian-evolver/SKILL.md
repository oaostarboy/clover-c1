...
```bash
mkdir -p $CLOVER_HOME/cache/darwinian-evolver && cd $CLOVER_HOME/cache/darwinian-evolver
...
```bash
cd $CLOVER_HOME/cache/darwinian-evolver/darwinian_evolver \
...
Open `$CLOVER_HOME/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=$CLOVER_HOME/skills/research/darwinian-evolver
DE_DIR=$CLOVER_HOME/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Clover core.
   Custom driver scripts under `$CLOVER_HOME/skills/...` are user-side and fine.
