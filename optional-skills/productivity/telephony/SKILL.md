...
### `$CLOVER_HOME/telephony_state.json`
...
```bash
SCRIPT="$(find $CLOVER_HOME/skills -path '*/telephony/scripts/telephony.py' -print -quit)"
```
...
```bash
python "$SCRIPT" twilio-call "+15551230000" --message "Hello! This is Clover calling with your status update." --voice Polly.Joanna
```
