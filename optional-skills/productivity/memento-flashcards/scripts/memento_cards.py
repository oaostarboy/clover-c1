...
Data file: $CLOVER_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CLOVER_HOME = Path(os.environ.get("CLOVER_HOME", Path.home() / ".clover"))
DATA_DIR = _CLOVER_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
