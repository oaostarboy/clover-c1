...
python ~/.clover/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.clover/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.clover/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.clover/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.clover/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.clover/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
