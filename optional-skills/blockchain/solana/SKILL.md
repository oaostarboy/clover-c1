...
version: 0.2.0
author: Deniz Alagoz (gizdusum), enhanced by Anthony Nguyen
license: MIT
...
Helper script path: $CLOVER_HOME/skills/blockchain/solana/scripts/solana_client.py
...
python $CLOVER_HOME/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python $CLOVER_HOME/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python $CLOVER_HOME/skills/blockchain/solana/scripts/solana_client.py price BONK
python $CLOVER_HOME/skills/blockchain/solana/scripts/solana_client.py price JUP
python $CLOVER_HOME/skills/blockchain/solana/scripts/solana_client.py price SOL
python $CLOVER_HOME/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
