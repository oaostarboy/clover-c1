...
Helper script: `$CLOVER_HOME/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python $CLOVER_HOME/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python $CLOVER_HOME/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python $CLOVER_HOME/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
