...
```bash
python ~/.clover/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.clover/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.clover/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
