...
- **Search both open *and* merged PRs and issues** for your topic or error symptom — the duplicate-check in the PR template fires at review time, after you've already done the work:
  ...
  ```
  Or use the web UI: [issues](https://github.com/oaostarboy/clover-c1) · [PRs (all states)](https://github.com/oaostarboy/clover-c1).
...
If your skill is specialized, community-contributed, or niche, it's better suited for a **Skills Hub** — upload it to a skills registry and share it in the [GitHub Discussions](https://github.com/oaostarboy/clover-c1/discussions). Users can install it with `clover skills install`.
...
- Promote it in the [GitHub Discussions](https://github.com/oaostarboy/clover-c1/discussions) so users can find and install it
...
- Use [GitHub Issues](https://github.com/oaostarboy/clover-c1)
