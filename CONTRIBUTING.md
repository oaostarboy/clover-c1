...
- **Search both open *and* merged PRs and issues** for your topic or error symptom — the duplicate-check in the PR template fires at review time, after you've already done the work:
  ...
  ```
  Or use the web UI: [issues](https://github.com/oaostarboy/clover-c1/issues) · [PRs (all states)](https://github.com/oaostarboy/clover-c1/pulls?q=is%3Apr).
...
If your skill is specialized, community-contributed, or niche, it's better suited for a **Skills Hub** — upload it to a skills registry and share it with the community. Users can install it with `clover skills install`.
...
- Announce it in GitHub Discussions so users can find and install it
...
- Use [GitHub Issues](https://github.com/oaostarboy/clover-c1/issues)
