      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via CLOVER_BUNDLED_SKILLS /
            # CLOVER_OPTIONAL_SKILLS (see clover-c1.nix), not via the
            ...
            # __init__.py) shipped via symlinks + CLOVER_BUNDLED_LOCALES
            # / CLOVER_OPTIONAL_MCPS, not via the wheel. Excluding them
