 ...
 *
 * Each entry is a key/value pair that lands in the packaged Clover.app's
 ...
 * "Clover wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Clover wants to access Music" when Clover never touches the Music
