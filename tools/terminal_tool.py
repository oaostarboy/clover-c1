...
def terminal_tool(
    ...
    try:
        ...
        # restart|stop targeting clover-gateway) must never run inside the
        ...
        if os.environ.get("_CLOVER_GATEWAY") == "1":
        ...
        if background:
            ...
            if sudo_cache_cleared:
                has_sudo_prompt_callback = _get_sudo_password_callback() is not None
                if has_sudo_prompt_callback or env_var_enabled("CLOVER_INTERACTIVE"):
                    output += (
