#!/usr/bin/env python3
"""Interact with the in-app browser / preview pane in the Clover desktop GUI.
...
def drive_preview_tool(
    ...
    if callback is None:
        return tool_error("drive_preview is only available in the Clover desktop app.")
...
ACT_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "the Clover desktop GUI — the pane open_preview opens beside this "
