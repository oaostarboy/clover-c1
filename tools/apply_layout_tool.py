#!/usr/bin/env python3
"""Apply a layout preset in the Clover desktop GUI.
...
_TIMEOUT_NOTE = "Layout apply is only available in the Clover desktop app."
...
APPLY_LAYOUT_SCHEMA = {
    "name": "apply_layout",
    "description": (
        "Apply a saved layout preset to the Clover desktop app when the user asks to "
