...
the get_anchored_view / get_messages_around primitives in clover_state.
...
from clover_state_common import _RESET_END_REASONS

# Sources that are excluded from session browsing/searching by default.
# Third-party integrations tag their sessions with CLOVER_SESSION_SOURCE=tool;
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches Clover conversation history only. It is not evidence "
        ...
        "reformat it as a markdown link or wrap it in backticks. Clover renders "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about Clover conversation history itself, such "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Clover profile's database "
