#!/usr/bin/env python3
"""Leave a mark on the page in the Clover desktop GUI's in-app browser.
...
def annotate_preview_tool(
    ...
    if callback is None:
        return tool_error("annotate_preview is only available in the Clover desktop app.")
...
ANNOTATE_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "pane of the Clover desktop GUI. Everything drive_preview draws as it "
