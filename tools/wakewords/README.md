...
`hey_clover.onnx` / `hey_clover.tflite` — the on-device "Hey Clover" hotword
...
- **Label:** the model registers as `hey_clover` (matches the filename).
