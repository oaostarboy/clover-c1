...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of CloverCognition/clover-c1#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of CloverCognition/clover-c1#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (CloverCognition/clover-c1#67052). ``ok`` stays
