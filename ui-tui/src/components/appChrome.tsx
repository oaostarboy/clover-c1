import { Box, type ScrollBoxHandle, stringWidth, Text } from '@clover/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (CLOVER_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (CLOVER_DEV_CREDITS), lowest priority,
