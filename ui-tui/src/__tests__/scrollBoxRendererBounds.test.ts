...
import { Box, renderSync, ScrollBox, type ScrollBoxHandle, Text } from '@clover/ink'
import React, { useLayoutEffect, useRef } from 'react'
import { describe, expect, it, vi } from 'vitest'

import SourceBox from '../../packages/clover-ink/src/ink/components/Box.js'
import SourceScrollBox from '../../packages/clover-ink/src/ink/components/ScrollBox.js'
import SourceText from '../../packages/clover-ink/src/ink/components/Text.js'
import type { DOMElement } from '../../packages/clover-ink/src/ink/dom.js'
import Output from '../../packages/clover-ink/src/ink/output.js'
import { scrollFastPathStats as sourceScrollFastPathStats } from '../../packages/clover-ink/src/ink/render-node-to-output.js'
import { renderSync as renderSourceSync } from '../../packages/clover-ink/src/ink/root.js'
