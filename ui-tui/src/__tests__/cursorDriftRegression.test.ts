 ...
 *
 * Symptom: in `clover --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@clover/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using clover --tui and as i type multiline my caret at the end will often ' +
