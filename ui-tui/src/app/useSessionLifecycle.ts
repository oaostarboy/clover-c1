...
import type { ScrollBoxHandle } from '@clover/ink'
import { evictInkCaches } from '@clover/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.CLOVER_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
