...
await build({
  ...
  // Skip the prebuilt @clover/ink bundle and inline the source instead:
  ...
  alias: { '@clover/ink': resolve(root, 'packages/clover-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The clover_cli launcher
