 ...
 * across theme x background scenes to <tmpdir>/clover-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@clover/ink'
...
// The regenerated slate light_colors block from clover_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/clover-c1',
...
const setup = (bgHex: string) => {
  process.env.CLOVER_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
