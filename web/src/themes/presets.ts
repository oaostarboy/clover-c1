 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `clover_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Clover Teal",
  description: "Classic dark teal — the canonical Clover look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Clover Teal (Large)",
  description: "Clover Teal with bigger fonts and roomier spacing",
