...
const STORAGE_KEY = "clover-dashboard-theme";
...
const FONT_STORAGE_KEY = "clover-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `clover_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "clover-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-clover-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-clover-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. Clover Blue) doesn't leave its values behind when the user
