 ...
 *
 * Values mirror clover_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Clover default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Clover' default when unset). */
