...
export const en: Translations = {
  ...
  app: {
    brand: "Clover Cognition",
    brandShort: "HA",
    closeNavigation: "Close navigation",
    closeModelTools: "Close model and tools",
    footer: {
      org: "Clover Cognition",
    },
  ...
  status: {
    ...
    updateCloverConfirmMessage:
      "This runs clover update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateCloverConfirmNow: "Update now",
    updateCloverConfirmTitle: "Update Clover?",
    updatingClover: "Updating Clover…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Clover plugins (`clover plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.clover/plugins/?",
    removeHint: "Only user-installed plugins under ~/.clover/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.clover/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Clover doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Clover Achievements",
      subtitle:
        "Collectible Clover badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Clover session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Clover more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Clover sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Clover is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Clover Cognition 🍀",
    },
  },
