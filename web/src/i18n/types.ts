...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateClover: string;
    updateCloverConfirmMessage?: string;
    updateCloverConfirmNow?: string;
    updateCloverConfirmTitle?: string;
    updatingClover: string;
  ...
  // ── Achievements plugin (plugins/clover-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
