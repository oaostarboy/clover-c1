 ...
 * `window.__CLOVER_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Clover brand in the top bar
 ...
 *  `window.__CLOVER_PLUGINS__.registerSlot(...)`.
 *
