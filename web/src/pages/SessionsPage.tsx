...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    clover_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__clover_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-Clover-Session-Token":
              (window as unknown as { __CLOVER_SESSION_TOKEN__?: string })
                .__CLOVER_SESSION_TOKEN__ ?? "",
          },
        });
