...
SPOTIFY_DOCS_URL = "docs/user-guide/features/spotify"
SPOTIFY_DASHBOARD_URL = "https://developer.spotify.com/dashboard"
SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120

OAUTH_OVER_SSH_DOCS_URL = "docs/guides/oauth-over-ssh"
...
def _file_lock(
    ...
    # A stress test with 20 concurrent Clover processes reproduced this
...
def _clover_portal_env_override() -> Optional[str]:
    ...
    ``CLOVER_PORTAL_BASE_URL=https://portal.staging-`` into
