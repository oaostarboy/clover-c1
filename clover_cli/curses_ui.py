"""Shared curses-based UI components for Clover CLI.

Used by `clover tools` and `clover skills` for interactive checklists.
...
_MENU_NAVIGATION_HANDLER: ContextVar[MenuNavigationHandler | None] = ContextVar(
    "clover_menu_navigation_handler", default=None
)
_NUMBERED_BACK_ENABLED: ContextVar[bool] = ContextVar(
    "clover_numbered_back_enabled", default=False
)
