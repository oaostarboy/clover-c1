"""Relay subscriber for the persisted Clover shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Clover counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Clover shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
