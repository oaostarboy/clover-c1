...
only viewable by Clover staff (and allowlisted Discord mods) through a
...
# Base URL of the Clover account service that mints the signed upload URL.
...
NAS_BASE = os.environ.get(
    "CLOVER_DIAGNOSTICS_BASE_URL", "https://portal.clover-c1.local"
)
...
_USER_AGENT = "clover-c1/debug-share"
