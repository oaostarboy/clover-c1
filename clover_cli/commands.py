...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("plan", "Write a markdown implementation plan to .clover/plans/ without executing anything", "Session",
               args_hint="[task]"),
    ...
    CommandDef("wake", "Toggle the 'Hey Clover' wake word listener", "Configuration",
               cli_only=True, args_hint="[on|off|status]",
               subcommands=("on", "off", "status")),
    CommandDef("busy", "Control how messages behave while Clover is working", "Configuration",
...
_SLACK_VIA_CLOVER_ONLY = frozenset({"topup", "moa", "debug", "egress", "init", "version", "diff", "update", "heartbeat", "refine", "review", "pause", "whoami", "platform", "insights"})
...
def slack_app_manifest(request_url: str = "https://clover-c1.local/slack/commands") -> dict[str, Any]:
...
def slack_subcommand_map() -> dict[str, str]:
    ...
    the same as /clover bg do stuff.
