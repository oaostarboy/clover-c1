"""``clover tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'clover tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # clover tools list [--platform cli]
    ...
    # clover tools disable <name...> [--platform cli]
    ...
    # clover tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `clover tools` runs after you pick a provider that\n"
