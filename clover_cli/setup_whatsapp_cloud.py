...
Entry point: ``clover whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``clover_cli/main.py``).
...
Clover gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Clover to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Clover needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Clover gateway in another terminal:")
    print("         clover gateway")
    print()
    ...
    print()
    print("  Docs: https://clover-c1.local/docs/user-guide/")
