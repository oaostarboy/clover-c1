...
def _reject_denylisted_env_var(key: str) -> None:
    ...
    if key in _ENV_VAR_NAME_DENYLIST:
        raise ValueError(
            ...
            "(CLOVER_HOME, CLOVER_PROFILE, ...) cannot be persisted via "
...
def ensure_clover_home():
    ...
    # silently mkdir-ing the old CLOVER_HOME would resurrect an empty skeleton
    ...
    if config_path.exists():
        try:
            ...
            print(
                ...
                f"  (clover config edit will open it in your editor.)",
                file=sys.stderr,
            )
            sys.exit(1)
