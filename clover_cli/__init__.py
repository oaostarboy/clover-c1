"""
Clover CLI - Unified command-line interface for Clover Cognition.

Provides subcommands for:
- clover chat          - Interactive chat (same as ./clover)
- clover gateway       - Run gateway in foreground
- clover gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `clover setup` on a fresh Pi.
    ...
    clover_cli/stdio.py::configure_windows_stdio() runs later from the entry
