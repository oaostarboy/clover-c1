...
Invoked by ``clover kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Clover Cognition board.
...
def _profile_author() -> str:
    """Mirror of ``clover_cli.kanban._profile_author``."""
    return (
