#!/usr/bin/env python3
"""
SWE Runner with Clover Trajectory Format

A runner that uses clover-c1's built-in execution environments
(local, docker, modal) and outputs trajectories in the clover-c1 format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses clover-c1's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Clover format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches clover-c1 format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using clover-c1's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Clover Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses clover-c1's built-in execution environments
    and outputs trajectories in clover-c1 format.
    """
    ...
    def _convert_to_clover_format(
        ...
        """
        Convert internal message format to Clover trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Clover trajectory format
        trajectory = self._convert_to_clover_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Clover trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Clover Trajectory Format")
    print("=" * 60)
