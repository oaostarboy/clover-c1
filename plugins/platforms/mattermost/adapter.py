...
required — uses aiohttp which is already a Clover dependency.
...
def interactive_setup() -> None:
    ...
    ``clover_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Clover delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # clover_cli/setup.py::_setup_mattermost function.
