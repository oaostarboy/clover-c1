"""
A2A (Agent-to-Agent) plugin for Clover Cognition.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Clover as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`clover gateway setup` flow for A2A."""
    ...
    print_info("Expose Clover as an A2A-discoverable agent and call other A2A agents.")
