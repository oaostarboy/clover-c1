...
Config: ~/.clover/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.clover/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_clover_home()`` helper (CLOVER_HOME-aware and
...
RULES_FILE = get_clover_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_clover_home() / "feishu_comment_pairing.json"
