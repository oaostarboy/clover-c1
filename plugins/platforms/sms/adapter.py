...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Clover gateway adapter.

    Each inbound phone number gets its own Clover session (multi-tenant).
...
# static dict in clover_cli/gateway.py, and the _send_sms dispatch in
