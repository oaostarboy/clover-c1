...
two endpoints so a fresh Clover install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``clover tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `clover tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `clover tools` for reliable service."
            ),
        }
