...
existing Clover Portal access token (the same token it already uses to call the
...
class NasCronClient:
    ...
    Uses the agent's refresh-aware Clover access token for auth. No scheduler
