...
Configuration
-------------
Secret (lives in $CLOVER_HOME/.env or the environment):
...
Behavioral settings (live in $CLOVER_HOME/mem0.json, set via `clover memory
setup`):
  ...
  agent_id           — Agent identifier (default: clover)
...
def _load_config() -> dict:
    """Load config from env vars, with $CLOVER_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "clover"),
        "oss": {},
    }
    ...
    config_path = get_clover_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, clover_home):
        """Write config to $CLOVER_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $CLOVER_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "clover")
