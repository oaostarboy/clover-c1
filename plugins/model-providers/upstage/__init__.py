...
# When the user hasn't picked a reasoning effort, Clover passes
...
# ON at this effort — matching the "medium (default)" that Clover' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Clover' effort vocabulary onto Solar's accepted set via the
