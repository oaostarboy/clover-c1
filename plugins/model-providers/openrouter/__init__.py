...
class OpenRouterProfile(ProviderProfile):
    ...
    def fetch_models(
        ...
        *,
        ...
        Note: Tool-call capability filtering is applied by clover_cli/models.py
    ...
    def build_extra_body(
        ...
        #
        # Mirrors the Clover Portal profile, which resolves the same way
    ...
    def build_api_kwargs_extras(
        ...
        **context: Any,
        ...
        if supports_reasoning:
            ...
            # model default to adaptive. See clover-c1#42991 (disable case)
            ...
            # live token-spend probe in clover-c1#43432). Route the existing
