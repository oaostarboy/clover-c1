...
request omits ``thinking``.  Clover' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Clover reasoning
...
(per Z.AI / BigModel docs).  Clover' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map Clover reasoning effort onto GLM's native vocabulary.
