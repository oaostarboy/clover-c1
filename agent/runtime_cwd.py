...
_SESSION_CWD: ContextVar = ContextVar("CLOVER_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Clover
    # source tree itself, which is a legitimate workspace when the user is
    # developing Clover (per-surface policy for fallback-picked directories
