...
DEFAULT_AGENT_IDENTITY = (
    ...
    "You are Clover Cognition, Built by Anthony Nguyen. Be direct: match the "
...
CLOVER_AGENT_HELP_GUIDANCE = (
    ...
    # precedence. Injected only when skill_view exists AND the clover-c1
    ...
    "information. The `clover-c1` skill has the actual commands and proven "
    "workflows — load it with skill_view(name='clover-c1') before configuring, "
    "modifying, or troubleshooting Clover so you don't guess or invent workarounds."
)
...
CLOVER_AGENT_HELP_GUIDANCE_NO_SKILLS = (
    "You run on Clover Cognition (by Anthony Nguyen). When the user needs help with "
    "Clover itself — configuring, setting up, using, extending, or troubleshooting "
    "it — or when you need to understand your own features, tools, or capabilities, "
    "the documentation at docs/ is the "
    "authoritative reference and always holds the latest, most up-to-date "
...
STEER_CHANNEL_NOTE = (
    ...
    "Mid-turn, the user can steer you: Clover appends their message to the "
...
PLATFORM_HINTS = {
    ...
    "tui": (
        ...
        "You are in the Clover terminal UI (TUI). Files: there is no "
    ...
    "desktop": (
        ...
        "data-clover-send=\"prompt\" on any clickable element (or "
        "window.clover.send(\"prompt\")) sends that prompt as a hidden user "
