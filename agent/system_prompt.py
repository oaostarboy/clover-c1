...
def _ra():
    ...
    ``build_context_files_prompt``, ``build_clover_subscription_prompt``,
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    # Pointer to the clover-c1 skill + docs for user questions about Clover itself.
    stable_parts.append(CLOVER_AGENT_HELP_GUIDANCE)
    ...
    clover_subscription_prompt = _r.build_clover_subscription_prompt(agent.valid_tool_names)
    if clover_subscription_prompt:
        stable_parts.append(clover_subscription_prompt)
