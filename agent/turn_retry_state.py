...
anthropic, clover, copilot), a long-context compression restart, a length-
...
class TurnRetryState:
    ...
    clover_auth_retry_attempted: bool = False
    clover_paid_entitlement_refresh_attempted: bool = False
