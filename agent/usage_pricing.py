...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Fireworks AI — serverless pricing for the models clover typically routes
...
# onto the base entries so the snapshot stays single-source. The Clover-side
...
def resolve_billing_route(
    ...
    if provider_name == "clover" or base_url_host_matches(base_url or "", "inference-api.clover-c1.local"):
