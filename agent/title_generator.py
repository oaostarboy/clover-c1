...
# Clover' own machine-authored openers. A compaction handoff or a resumed
...
def _auto_title_enabled() -> bool:
    ...
    try:
        ...
        # from agent code paths where a module-level clover_cli import risks
...
def auto_title_session(
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running Clover process): %s",
            e,
        )
...
def _is_real_user_turn(message: Any) -> bool:
    ...
    Clover persists a lot of machinery under ``role="user"`` — compaction
