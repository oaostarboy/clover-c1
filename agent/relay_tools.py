"""Core NeMo Relay adapter for Clover tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Clover tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Clover Relay tool execution cannot run on an active event-loop thread"
    )
