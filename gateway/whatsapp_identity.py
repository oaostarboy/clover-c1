...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$CLOVER_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_clover_dir("platforms/whatsapp/session", "whatsapp/session")
