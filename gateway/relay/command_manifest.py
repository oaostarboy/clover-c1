...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Clover session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Clover session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Clover agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Clover Cognition to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Clover gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Clover session in it",
