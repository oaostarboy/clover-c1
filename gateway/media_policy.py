...
from environment variables:
  ...
  - ``CLOVER_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``CLOVER_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``CLOVER_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``clover cron run`` in the CLI, ``clover send``, a
...
_STRICT_ENV = "CLOVER_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "CLOVER_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "CLOVER_MEDIA_TRUST_RECENT_FILES"
