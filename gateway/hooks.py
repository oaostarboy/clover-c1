...
Hooks are discovered from ~/.clover/hooks/ directories, each containing:
...
HOOKS_DIR = get_clover_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"clover_hook_{hook_name}"
