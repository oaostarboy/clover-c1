...
benchmarked ten harnesses on hostile-file handling — and whose Clover column
...
Every task runs the full Clover agent (file + terminal + search toolsets)
...
Rules of engagement (from cloverbench discipline):
