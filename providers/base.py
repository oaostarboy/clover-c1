...
def _profile_user_agent() -> str:
    """Return a ``clover-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from clover_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"clover-cli/{_ver}"
    except Exception:
        return "clover-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # clover-cli UA so the catalog endpoint is reachable.
