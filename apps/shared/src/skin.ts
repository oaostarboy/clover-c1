/**
 * Canonical Clover skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$CLOVER_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`clover_cli/skin_engine.py`),
 ...
 *   • CLI     → `clover_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
