...
cd apps/desktop
XCURSOR_SIZE=24 CLOVER_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/clover-typing
# → /tmp/clover-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/clover-typing.before.heapsnapshot
# → /tmp/clover-typing.after.heapsnapshot
```
