...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @clover/plugin-sdk (+ react), never `@/…`
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@clover/shared'],
              message: 'Plugins import only @clover/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
