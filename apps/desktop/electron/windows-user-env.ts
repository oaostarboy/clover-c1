...
// even though a fresh shell — and the Clover CLI — sees it immediately. The
// desktop's CLOVER_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\clover. Reading
...
//       CLOVER_HOME    REG_SZ    F:\Clover\data
//
