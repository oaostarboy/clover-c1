 ...
 * startClover() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startClover() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startClover`, re-emits
