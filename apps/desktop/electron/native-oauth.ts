 ...
 * Apps) login to a gated Clover gateway: system-browser + loopback redirect +
 ...
 * upstream IDP (Clover Portal) issues a per-gateway-instance client_id and only
...
// clover_cli/web_server.py status handler.
