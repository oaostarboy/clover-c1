...
// by main.ts (`setBackgroundThrottling` driven by the merged `clover:active-work`
...
// (the "Clover idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Clover" wake word has NO preceding click,
