...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshCloverPathTitle: string
      sshCloverPathDesc: string
      sshCloverPathPlaceholder: string
  ...
  commandCenter: {
    ...
    cloverActiveSessions: (version: string, count: number) => string
