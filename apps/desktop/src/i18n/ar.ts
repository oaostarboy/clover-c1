...
export const ar = defineLocale({
  sendDiagnostics: {
    ...
    failedHint:
      'يمكنك أيضاً تشغيل `clover debug share --nous` من الطرفية، أو `clover debug share --local` لعرض التقرير دون رفعه.',
  ...
  settings: {
    ...
    toolsets: {
      ...
      ready: 'جاهز',
      nousIncluded: 'مُضمّن مع اشتراك Clover — سجّل الدخول إلى Clover Portal للتفعيل.',
