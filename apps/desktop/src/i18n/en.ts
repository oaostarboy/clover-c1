...
export const en: Translations = {
  ...
  boot: {
    ready: 'Clover Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Clover settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Clover backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingCloverDesktop: 'Starting Clover Desktop…'
    },
    errors: {
      backgroundExited: 'Clover background process exited.',
      backgroundExitedDuringStartup: 'Clover background process exited during startup.',
    ...
    failure: {
      ...
      cloudDownTitle: 'Clover Cloud agent is down',
      cloudDownDescription:
        'The Clover-managed cloud agent this gateway connects to is returning a server error. It cannot be restarted from here — check its status, switch to the local gateway, or get support.',
      cloudDownHint:
        'The buttons below open the Clover Portal (instance status and controls) and our Discord for support.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Clover backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateClover: 'Update Clover',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Clover Desktop.',
    ...
    native: {
      ...
      inputBody: 'Clover is waiting for your response.',
      turnDoneTitle: 'Clover finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    title: 'Send diagnostics to Clover',
    privacyNotice:
      'This uploads a debug bundle to Clover-internal storage (not a public paste). It includes system info (OS, versions, provider, which API keys are configured — never the keys themselves) and full agent, gateway, and desktop logs (up to 512 KB each), which likely contain conversation content, tool outputs, and file paths. Secrets are redacted before upload. The bundle is viewable only by Clover staff and allowlisted Discord moderators, and auto-deletes after 14 days.',
    upload: 'Upload',
    uploading: 'Uploading…',
    cancel: 'Cancel',
    close: 'Close',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Clover defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Clover backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Clover backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.clover/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Clover is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Clover asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Clover was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Clover was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Clover follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Clover can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Clover when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Clover walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Clover is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Clover, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Clover Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Clover runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Clover checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Clover configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Clover.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Clover gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Clover Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Clover Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Clover runtime managed by this app.',
      kindRemoteDesc: 'A Clover gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Clover Cloud account.',
      kindSshDesc: 'A Clover install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Clover manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Clover Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Clover backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset CLOVER_DESKTOP_REMOTE_URL and CLOVER_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Clover backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Clover backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Clover Cloud',
      cloudDesc: 'Sign in once to Clover Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Clover Cloud',
      cloudSignIn: 'Sign in to Clover Cloud',
      cloudSignedIn: 'Signed in to Clover Cloud',
      cloudNeedsSignIn: 'Sign in to Clover Cloud to discover the agents on your account.',
      ...
      cloudNoAgents: {
        ...
        linkText: 'Clover portal',
        after: ', then refresh.'
      },
      cloudRefresh: 'Refresh',
      cloudConnect: 'Connect',
      cloudConnecting: 'Connecting…',
      cloudDiscoverFailed: 'Could not load your Clover Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Clover Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Clover Cloud',
      cloudSignedOutMessage: 'Cleared the Clover Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /clover.',
      ...
      restartingMessage: 'Clover Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Clover ${version}` : ''}`,
      ...
      sshDesc:
        'Clover is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshCloverPathTitle: 'Clover path (optional)',
      sshCloverPathDesc: 'Full path to the remote clover binary. Blank = auto-detect.',
      sshCloverPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Clover found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Clover runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrUpdateRequired: 'Update Clover on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Clover. Review the exact configuration below — it comes from the link, not from Clover.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Clover runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Clover at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via clover curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Clover builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Clover to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Clover to generate pets.',
      backgroundHint: 'You can close this — Clover will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Clover desktop' },
    ...
    cloverActiveSessions: (version, count) => `Clover ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@clover:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Clover you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://clover.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Clover environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Clover did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Clover will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Clover backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Clover. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Clover backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Clover...',
    placeholderReconnecting: 'Reconnecting to Clover…',
    ...
    attachUrlDesc: 'Clover will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Clover to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Clover…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Clover…',
    ...
    unsupportedMessage: 'This version of Clover can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Clover from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Clover will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Clover desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Clover updater takes over in its own window and reopens Clover automatically when it’s done. Please don’t reopen Clover yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Clover reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Clover reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Clover?',
    blockerBody:
      'Clover needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Clover',
    foreignBlockerBody:
      'Clover can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Clover can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Clover needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Clover Desktop',
    setupChoiceDesc:
      'Connect this app to a Clover gateway you already run, or install Clover locally on this computer.',
    connectExistingTitle: 'Connect to existing Clover',
    ...
    installLocalTitle: 'Install Clover locally',
    installLocalDesc: 'Download Clover, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Clover Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Clover',
    remoteSetupDesc: 'Enter your gateway URL. Clover Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Clover gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/clover',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Clover gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Clover Cognition',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Clover CLI or desktop instance is running. Stop any running Clover instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Clover',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Clover at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Clover connects automatically',
    ...
    authorizeThere: 'Authorize Clover there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Clover there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Clover subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Clover Desktop v${version}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Clover will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Clover is restarting...',
      askRestart: 'Ask Clover to restart the server',
      lookingRestart: taskId => `Clover is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Clover is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Clover to open a page.',
      finishedRestarting: message => `Clover finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Clover could not restart the server.',
      stillWorking:
        'Clover is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Clover is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Clover gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.clover/config.yaml). Clover won’t ask again for commands like this — in this session or any future one.`,
    ...
    mcpSetup: {
      ...
      catalogSource: 'From the Clover-approved catalog',
  ...
  prompts: {
    ...
    sudoDesc: 'Clover needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Clover needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Clover Desktop to use Save Image.',
    restartToSaveImages: 'Restart Clover Desktop to save images',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Clover loads when the work calls for them.'
      },
      messaging: {
        title: 'Clover away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Clover made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Clover — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
