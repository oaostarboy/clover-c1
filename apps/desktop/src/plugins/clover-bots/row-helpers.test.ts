 ...
 *    the primary profile surfaced as @default instead of @clover;
 ...
 *    kanban/tool workers count too (clover-c1#90268): a profile grinding
...
describe('previewKind classifies a roster preview', () => {
  ...
  it('surfaces the primary profile as @clover, never @default (#89484)', () => {
    expect(fromBot("Message from agent 'default': deploy is green")).toBe('clover')
