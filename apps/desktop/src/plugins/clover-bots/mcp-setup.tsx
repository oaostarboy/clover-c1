...
import { Button, host, Input, useI18n } from '@clover/plugin-sdk'
...
export function McpSetupButton({ profile, entry, onDone, ensureProfile }: McpSetupButtonProps) {
  ...
  const beginOAuth = async () => {
    ...
    const mcpOauthBridge =
      typeof window !== 'undefined' && window.cloverDesktop && window.cloverDesktop.mcpOauth
        ? window.cloverDesktop.mcpOauth
        : null
