...
test('generated protocol uses clover profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `clover profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `clover profiles list` for the LIVE/)
})
