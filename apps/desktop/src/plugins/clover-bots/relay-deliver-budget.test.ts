...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/clover-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'clover_cli/config_defaults.py'), 'utf8')
