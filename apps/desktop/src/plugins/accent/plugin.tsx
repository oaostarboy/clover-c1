...
import type { CloverPlugin, PaletteContribution } from '@clover/plugin-sdk'
import { $accentOverride, PALETTE_AREA, setAccentOverride, STATUSBAR_AREAS } from '@clover/plugin-sdk'

import { AccentPickerTrigger } from './picker'

const plugin: CloverPlugin = {
  id: 'accent',
  name: 'Accent Picker',
  description:
