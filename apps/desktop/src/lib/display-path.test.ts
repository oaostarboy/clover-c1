...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/clover-c1')).toBe('~/www/clover-c1')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/clover-c1')).toBe('clover-c1')
    expect(pathLeaf('~/www/clover-c1')).toBe('clover-c1')
