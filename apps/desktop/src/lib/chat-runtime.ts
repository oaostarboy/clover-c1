...
import type { ModelOptionsResponse, SessionInfo } from '@/types/clover'
 ...
 *
 * Only the leading status prefix (e.g. "Clover is thinking...") and the
 ...
 *  resolved comment as JSON (CloverPrComment shape); a malformed payload falls
