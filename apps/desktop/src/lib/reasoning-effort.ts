...
/** Clover' reasoning levels, in ascending order — mirrors the backend's
 *  VALID_REASONING_EFFORTS (clover_constants.py). `none` is not a level: it's
...
/** Clover' built-in level when neither the surface nor the profile config
