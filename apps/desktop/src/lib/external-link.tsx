...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|clover):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.cloverDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.cloverDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Clover, and it is the surface the agent
