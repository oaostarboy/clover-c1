 ...
 * plugins resolve `@clover/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __CLOVER_PLUGIN_SDK__: sdk,
  __CLOVER_REACT__: React,
  __CLOVER_REACT_JSX__: jsxRuntime,
  __CLOVER_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@clover/plugin-sdk': shimUrl('__CLOVER_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__CLOVER_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__CLOVER_REACT_JSX__'),
    react: shimUrl('__CLOVER_REACT__')
  }
