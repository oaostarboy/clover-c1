...
export function updateMessagingPlatform(
  ...
  return cloverApi<{ ok: boolean; platform: string }>({
    ...profileScoped(profile),
...
export function testMessagingPlatform(
  ...
  return cloverApi<MessagingPlatformTestResponse>({
    ...profileScoped(profile),
...
export function getPairing(profile?: null | string): Promise<PairingResponse> {
  return cloverApi<PairingResponse>({
    ...profileScoped(profile),
    path: '/api/pairing'
  })
}
...
export function approvePairing(
  ...
  return cloverApi<{ ok: boolean; user: PairingUser }>({
    ...profileScoped(profile),
...
export function getWebhooks(): Promise<WebhooksResponse> {
  return cloverApi<WebhooksResponse>({
    ...profileScoped(),
    path: '/api/webhooks'
  })
}
...
export function enableWebhooks(): Promise<WebhookEnableResponse> {
  return cloverApi<WebhookEnableResponse>({
    ...profileScoped(),
...
export function createWebhook(body: WebhookCreatePayload): Promise<WebhookCreateResponse> {
  return cloverApi<WebhookCreateResponse>({
    ...profileScoped(),
    path: '/api/webhooks',
    method: 'POST',
    body
...
export function setWebhookEnabled(
  ...
  return cloverApi<{ enabled: boolean; name: string; ok: boolean }>({
    ...profileScoped(),
