 ...
 * - It covers Clover too. "Off" from someone who has just closed a bubble means
...
export const $tipsEnabled = persistentAtom('clover.desktop.tips.rotation.v1', true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('clover.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('clover.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'clover.desktop.tips.next.v1',
  null,
