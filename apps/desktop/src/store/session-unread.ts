...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('clover.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('clover.desktop.unreadFinishedSessions')
