...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://clover.example.com:8443/x')).toBe('clover.example.com:8443')
    expect(remoteHostLabel('https://clover.example.com:443')).toBe('clover.example.com')
    expect(remoteHostLabel('http://clover.example.com:80')).toBe('clover.example.com')
  })
