...
const POPOUT_STORAGE_KEY = 'clover.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'clover.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'clover.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'clover.desktop.composerPopout.position'
