...
function identityForConnection(connection: CloverConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: CloverConnection | null): void {
