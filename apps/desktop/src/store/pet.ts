...
export interface PetInfo {
  ...
  // the Clover "run" activity state uses the in-place running row).
 ...
 * CLOVER_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'clover.desktop.pet-roam.v1'
