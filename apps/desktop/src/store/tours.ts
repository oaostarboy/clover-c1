 ...
 * unlike tips there is no ambient half to separate out — every tour is Clover
...
export const $toursEnabled = persistentAtom('clover.desktop.tours.v1', true, Codecs.bool)
