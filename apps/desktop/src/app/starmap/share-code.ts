...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/clover'
...
const VERSION = 3
const PREFIX = 'HML' // "Clover Memory Loadout" — namespaces our codes like WoW's leading bytes.
