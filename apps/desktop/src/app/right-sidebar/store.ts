...
const TAKEOVER_KEY = 'clover.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Clover can't clear via the API — the user
 *  sees exactly what runs instead of Clover silently deleting their creds. */
