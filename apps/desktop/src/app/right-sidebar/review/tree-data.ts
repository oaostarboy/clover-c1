import type { CloverReviewFile } from '@/global'
...
export function buildReviewFlatList(files: CloverReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: CloverReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
