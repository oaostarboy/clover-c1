...
import { getCloverConfigRecord, listAllProfileSessions } from '@/clover'
...
// Clover session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-clover',
            keywords: ['update', 'upgrade', 'clover', 'version', 'system', 'restart'],
            label: cc.updateClover,
  ...
  const searchGroups = useMemo<PaletteGroup[]>(() => {
    ...
    // Apply a theme directly from the root search (e.g. "clover" → Clover). Live
