...
// hairline `--stroke-clover` paired with the soft `--shadow-clover` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-clover) bg-(--ui-chat-bubble-background) shadow-clover [-webkit-app-region:no-drag]'
