import { isGatewayReauthRequired, resolveGatewayWsUrl } from '@clover/shared'
...
interface GatewayBootOptions {
  ...
  refreshCloverConfig: () => Promise<void>
    ...
    const softSwitch = async () => {
      ...
      try {
        ...
        await Promise.all([
          ...
          callbacksRef.current.refreshCloverConfig().catch(() => undefined),
