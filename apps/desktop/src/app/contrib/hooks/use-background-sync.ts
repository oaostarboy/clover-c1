...
import { getLatestSessionMessages, type ProfileScope } from '@/clover'
...
interface BackgroundSyncParams {
  ...
  refreshCloverConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshCloverConfig])
}
