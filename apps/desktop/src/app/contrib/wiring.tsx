...
export function ContribWiring({ children }: { children: ReactNode }) {
  ...
  const { refreshCloverConfig, sttEnabled, voiceMaxRecordingSeconds } = useCloverConfig({ activeSessionIdRef })
  ...
  useEffect(() => {
    ...
    window.addEventListener('clover:open-keybinds', onOpenKeybinds)
  ...
  useEffect(() => {
    ...
    void refreshCloverConfig(true)
    void refreshActiveProfile()
    resetProjectTreeState()
  }, [gatewayScope, refreshCurrentModel, refreshCloverConfig])
