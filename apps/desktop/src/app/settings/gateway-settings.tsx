...
// Clover Cloud discovery lifecycle for the cloud-mode panel.
...
export function GatewaySettings({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  const signOut = async () => {
    ...
    try {
      await window.cloverDesktop.oauthLogoutConnectionConfig(trimmedUrl || undefined)
      const refreshed = await window.cloverDesktop.getConnectionConfig(null)
  ...
  return (
    <SettingsContent bare={embedded}>
      ...
      {/* Clover Cloud panel: one portal sign-in, then a discovered-agent picker
                ...
                {cloudDiscover === 'loading' ? (
                  ...
                  <div className="flex items-start gap-2 py-3 text-[length:var(--conversation-caption-font-size)] text-(--ui-text-tertiary)">
                    ...
                    <span>
                      ...
                      <ExternalLink href="https://portal.clover-c1.local/agents" showExternalIcon={false}>
