...
import { setCloverConfigCache, useCloverConfigRecord } from '../hooks/use-config-record'
...
function fontFamilyFromConfig(config: CloverConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useCloverConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<CloverConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setCloverConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="clover-terminal-font-families"
          ...
          <datalist id="clover-terminal-font-families">
