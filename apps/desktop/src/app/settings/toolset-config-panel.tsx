 ...
 * server-computed `status` (keys ∧ Clover entitlement ∧ post-setup install
 ...
 * log inline — the GUI equivalent of the install step `clover tools` runs
...
/**
 * Backend model catalog — the GUI counterpart of the model picker `clover
...
export function ToolsetConfigPanel({ toolset, onConfiguredChange, profile }: ToolsetConfigPanelProps) {
  ...
  // panel highlighted the first keyless provider (e.g. Clover Portal) even when
