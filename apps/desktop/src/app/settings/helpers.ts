...
import type { CloverConfigRecord, ConfigFieldSchema, ToolsetInfo } from '@/types/clover'
...
export function getNested(obj: CloverConfigRecord, path: string): unknown {
  let cur: unknown = obj
 ...
 */
export function clearsEnabledToolsets(prev: CloverConfigRecord, next: CloverConfigRecord): boolean {
...
export function voiceFieldVisible(key: string, config: CloverConfigRecord): boolean {
...
export function setNested(obj: CloverConfigRecord, path: string, value: unknown): CloverConfigRecord {
...
function personalityOptions(config: CloverConfigRecord): string[] {
...
function commandProviderNames(config: CloverConfigRecord, section: 'tts' | 'stt'): string[] {
