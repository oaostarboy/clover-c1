...
import { transcribeAudio } from '@/clover'
...
export function usePromptActions({
  ...
  // succeeds on CLOVER01 and prompt.submit immediately fails locally with
  // "session not found".
  ...
  // separate `clover gateway` process performs the actual transfer, so we
