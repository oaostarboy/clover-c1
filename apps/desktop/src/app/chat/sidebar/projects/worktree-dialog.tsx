...
import type { CloverGitBranch } from '@/global'
...
const branchActionLabel = (branch: CloverGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<CloverGitBranch[]>([])
  ...
  const convert = async (branch: CloverGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
