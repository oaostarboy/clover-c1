...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/clover'
...
// highlight markers (sqlite snippet() delimiters — see clover_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('clover:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('clover:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Clover to
