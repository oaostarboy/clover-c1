...
const FOCUS_EVENT = 'clover:composer-focus'
const INSERT_EVENT = 'clover:composer-insert'
const ATTACH_IMAGES_EVENT = 'clover:composer-attach-images'
const INSERT_REFS_EVENT = 'clover:composer-insert-refs'
const SUBMIT_EVENT = 'clover:composer-submit'
const VOICE_TOGGLE_EVENT = 'clover:composer-voice-toggle'
const MODEL_MENU_EVENT = 'clover:composer-model-menu'
