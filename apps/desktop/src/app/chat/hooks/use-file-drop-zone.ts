...
import { CLOVER_PATHS_MIME, type DroppedFile, extractDroppedFiles } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, CLOVER_PATHS_MIME) ? 'files' : null
