 ...
 * `<clover home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'clover.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'clover.desktop.disabledPlugins.v1'
