 ...
 * usable — it only offers recovery: Clover opens Settings → Billing in-app, other
...
export function BillingBanner({ sessionId }: { sessionId: null | string }) {
  ...
  const title = block.is_clover_portal ? copy.titleCloverCredits : copy.titleProvider(block.provider_label)
