...
const STORAGE_KEY = 'clover.desktop.layoutTree.v2'

writeKey('clover.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('clover.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('clover.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'clover.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'clover.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'clover.desktop.hiddenStripTabs.v1'
...
writeKey('clover.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__CLOVER_LAYOUT_TREE__ = {
    close: closeTreePane,
