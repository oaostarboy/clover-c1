...
export const CLOVER_CONTEXT_MENU_TRIGGER_ATTR = 'data-clover-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-clover-context-menu-trigger="" />
  )
}
