 ...
 *  smallest type, soft clover shadow. Uses an explicit fill (not `--composer-fill`)
...
export const composerPanelCard = cn(
  'rounded-2xl border border-border/65 shadow-clover text-[length:var(--conversation-tool-font-size)]',
