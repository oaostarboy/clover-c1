...
import type { ModelOptionProvider, ModelPricing } from '@/types/clover'
...
export function ModelPickerDialog({
  ...
  // the `clover model` CLI picker, which shows the curated list verbatim.
...
function ProviderHeading({ provider }: { provider: ModelOptionProvider }) {
  ...
  // free_tier is only set for Clover. true → "Free tier", false → "Pro".
  const tierBadge =
