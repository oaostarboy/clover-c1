/**
 * Clover skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$CLOVER_HOME/skins/` (or a
 * built-in) resolved by `clover_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Clover authors from a prompt lights up all three surfaces from one file.
 *
...
import type { CloverSkin, SkinColors } from '@clover/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: CloverSkin): DesktopTheme | null {
