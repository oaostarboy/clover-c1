...
/**
 * Clover — the canonical Clover desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Clover's own: a VS Code theme carries no font opinion, and
...
export const DEFAULT_SKIN_NAME = 'clover'
