...
// (#73044). Exercises the REAL clover + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/clover')
...
const conn = (over: Partial<CloverConnection> = {}): CloverConnection =>
  ({
    authMode: 'oauth',
