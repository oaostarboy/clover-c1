...
def main() -> None:
    ...
    clover_home = Path(tempfile.mkdtemp(prefix="clover-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "clover-gateway-smoke",
    ...
    print(json.dumps({"clover_home": str(clover_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
