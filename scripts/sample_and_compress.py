...
DEFAULT_DATASETS = [
    "cloverc1/swe-terminus-agent-glm-kimi-minimax",
    "clover-c1-megascience-sft1",
    "cloverc1/clover-c1-Thinking-GLM-4.7-SFT2",
    "cloverc1/clover-c1-Thinking-GLM-4.7-SFT1",
    "cloverc1/terminal-tasks-glm-clover-c1"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "cloverc1/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload cloverc1/{output_name} {final_output}")
