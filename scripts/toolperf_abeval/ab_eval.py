...
measured in the production session DB) through `clover chat` twice — once per
...
Environment:
  ...
  ABEVAL_HOME    CLOVER_HOME for runs   (default: $ABEVAL_ROOT/home)
                 Must be a configured Clover home with credentials for the
...
""".strip(),
            ...
            env.update({
                ...
                "CLOVER_NEMO_RELAY_PLUGINS_TOML": str(relay_config),
            })
