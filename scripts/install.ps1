...
function Write-Banner {
    ...
    Write-Host "+---------------------------------------------------------+" -ForegroundColor Magenta
    Write-Host "|  An open source AI agent by Clover Cognition.              |" -ForegroundColor Magenta
    Write-Host "+---------------------------------------------------------+" -ForegroundColor Magenta
    Write-Host ""
}
...
# Upgrade the Clover-managed Node tree's bundled npm into $NpmRange.
#
...
function Test-Node {
    ...
    if (Get-Command node -ErrorAction SilentlyContinue) {
        ...
        Write-Warn "Node.js $version is too old (Clover requires Node >=26)"
    }
...
function Copy-ConfigTemplates {
    ...
    if (-not (Test-Path $soulPath)) {
        ...
        $soulContent = @"
You are Clover Cognition, an intelligent AI assistant created by Clover Cognition. You are helpful, knowledgeable, and direct. You assist users with a wide range of tasks including answering questions, writing and editing code, analyzing information, creative work, and executing actions via your tools. You communicate clearly, admit uncertainty when appropriate, and prioritize being genuinely useful over being verbose unless otherwise directed below. Be targeted and efficient in your exploration and investigations.
"@
        $utf8NoBom = New-Object System.Text.UTF8Encoding($false)
...
function Install-Desktop {
    ...
    # enforces the build floor (Node >=26) and prepends the Clover-managed
