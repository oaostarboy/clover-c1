#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Clover logs.
...
With no LOGFILE, reads ``$CLOVER_HOME/logs/agent.log`` (default ~/.clover).
...
def default_log() -> Path:
    home = os.environ.get("CLOVER_HOME") or str(Path.home() / ".clover")
