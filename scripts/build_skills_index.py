#!/usr/bin/env python3
"""Build the Clover Skills Index — a centralized JSON catalog of all skills.
...
`clover skills search/install` can use it without hitting the GitHub API.
...
# Ensure CLOVER_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("CLOVER_HOME", os.path.join(os.path.expanduser("~"), ".clover"))
...
def main():
    print("Building Clover Skills Index...", flush=True)
