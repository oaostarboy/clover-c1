...
Registry of record: `clover_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Clover config+state snapshots (CLI)
...
/council [mode] <question> Run the adversarial multi-model council (GW)
