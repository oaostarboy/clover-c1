/**
 * Clover desktop plugin template. Save as:
 *   <clover home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <clover home> is ~/.clover by default, or ~/.clover/profiles/<name>
 * when running a named profile (`clover -p <name>`). Run `clover doctor` (or
 ...
 * Only these imports resolve: @clover/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@clover/plugin-sdk'
