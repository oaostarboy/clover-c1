...
Built for [Clover Cognition](https://github.com/CloverCognition/clover-c1). Usable in any coding agent. Canonical source lives here; synced to [`CloverCognition/clover-c1/skills/creative/ascii-video`](https://github.com/CloverCognition/clover-c1/tree/main/skills/creative/ascii-video) via PR.
